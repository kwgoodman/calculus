...
such that $(\Delta b)_n = n^3-4n^2$. It is easy to find recursion relation:
...
used in this section allow us to find partial sums of (some of the) sequences
$a_n$ that can be written as rational functions of $n$.
